...
export default function ReportPage() {
  ...
  // State to store new report details
  ...
  // State to store uploaded file and its preview
  const [file, setFile] = useState<File | null>(null);
  const [preview, setPreview] = useState<string | null>(null);

  // State to manage verification status and result
  ...
  // State for Google Maps SearchBox
  ...
  // Callback to handle SearchBox load
  ...
  // Handle waste verification using Google Generative AI
  ...
  // Check user authentication and fetch recent reports on component mount
  useEffect(() => {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      >
        ...
        {/* Form fields for location, type, and amount */}
